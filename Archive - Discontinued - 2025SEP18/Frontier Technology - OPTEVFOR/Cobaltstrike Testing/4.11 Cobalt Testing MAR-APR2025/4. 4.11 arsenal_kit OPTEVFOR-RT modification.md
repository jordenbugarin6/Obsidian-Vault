...
#### New 4.11 `arsenal_kit.config` - Before Changes

`sha256sum`
![[Pasted image 20250326191338.png]]

#### New 4.11 `arsenal_kit.config` with `OPTEV-RT` modifications

![[Pasted image 20250327172614.png]]
...
#### Building `arsenal_kit`


![[Pasted image 20250327172720.png]]