...
`good to know` hacking information for `mimikatz`:
...
# Good to know Mimikatz Stuff
`https://tools.thehacker.recipes/mimikatz/modules/lsadump/secrets`

# Explanation of different `SAM` `SECURITY` `SYSTEM` hives
