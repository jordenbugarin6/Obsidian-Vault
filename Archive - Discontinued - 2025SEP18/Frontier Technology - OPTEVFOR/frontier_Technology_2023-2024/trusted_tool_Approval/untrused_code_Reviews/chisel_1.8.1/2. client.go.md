https://raw.githubusercontent.com/jpillora/chisel/master/client/client.go
```go
package chclient

import (
	"context" // used to enable the connection between servers/clients
	"crypto/md5" // applies md5 hashing 
	"crypto/tls" // enables Transport Layer Security (TLS) Protocol
	"crypto/x509" // enables x509 certificates
	"encoding/base64" // Package base64 implements base64
	"errors" // allows errors
	"fmt" //  used to take I/O and send to screen //
	"io/ioutil" // used to read and write I/O and spit to screen , ioutil is deprecated 
	"net" // net allows portable interface for network I/o - required for connecting to sockets
	...
	"net/url" // allows for url strings to be used - required for proxies.
	"regexp" // enables utilization of regex
