...
```bash
┌──(root💀gobots)-[10Nov2024 06:40:56]-[/home/kali/SUT/OSWA]
└─# nmap -Pn -sV bambi -p-          
Starting Nmap 7.94SVN ( https://nmap.org ) at 2024-11-10 06:41 UTC
Nmap scan report for bambi (192.168.169.121)
